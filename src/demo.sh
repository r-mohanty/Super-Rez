python main.py --model cs143generative --batch_size 16 --grad_accum 1 --scale 4 --patch_size 192 --ema_beta 0.999 --lr 2e-5 --d_lr 2e-5 --betas 0.9 0.99 --loss 10*Fidelity+1*Regularization --r1_gamma 10 --save cs143_x4_gen --print_every 1 --save_results --save_gt --reset # --resume -1 --load cs143_x4_gen #
